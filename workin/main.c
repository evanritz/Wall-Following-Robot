...
{    
    ...
    /////////////////Local Variables/////////////
//    uint16_t desiredData = 5000;
//    uint16_t currentData = ic2TimeData[ic2TimeDataIdx-1];
//    
//    if(ic2TimeDataIdx > 1){
//        int temp_currentData = ic2TimeData[ic2TimeDataIdx-1] - ic2TimeData[ic2TimeDataIdx - 2];        //index -1 and -2 because index is incremented at end of IC2
...
//    /*-------------Button De-bouncing-------------*/
    ...
    if (ic2TimeDataIdx > 1)
    {
        ...
        float speed = 0.00547445255/secs;
