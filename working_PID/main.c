...
{    
    ...
    float Front_Distance = OPT0_DIST();
    float Front_Side_Distance = OPT2_DIST();
    float Back_Side_Distance = OPT1_DIST();
    float Max_Side_Distance = 16;        //inches
    float Min_Front_Distance = 4;
...
//    else if( (Front_Side_Distance > Max_Side_Distance) && (Back_Side_Distance > Max_Side_Distance)){
//        IC2_PID(0);
//        IC3_PID(0);
//    }
    else{
...
void AppInit() {
    ...
    PID_CTRL_1 = PID_INIT(&OC2R, &OC2RS, 1, 1, 5, 10000, -10000, 1.5);
    PID_CTRL_2 = PID_INIT(&OC3R, &OC3RS, 1, 1, 5, 10000, -10000, 1.5);
